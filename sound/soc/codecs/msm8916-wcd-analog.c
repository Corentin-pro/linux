...
static const struct snd_kcontrol_new lineout_mux = SOC_DAPM_ENUM("LINEOUT", hph_enum);
static const struct snd_kcontrol_new lineout_ext_mux = SOC_DAPM_ENUM("LINEOUT Ext PA", hph_enum);
